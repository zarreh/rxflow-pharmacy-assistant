...
class GeminiFactory(BaseLLMFactory):
    ...
    def create_llm(self, config: LLMConfig) -> BaseLanguageModel:
        if not GEMINI_AVAILABLE:
            raise ImportError("Google Gemini not available. Install with: pip install langchain-google-genai")
...
class LLMManager:
    ...
    def switch_provider(self, provider: Union[str, LLMProvider]):
        """Switch default provider and clear cache"""
